      ...
      <div className="mb-[20px] pt-0 z-30 fixed top-0 left-0 right-0 bg-[#15171a] opacity-90">
        <div className=" px-10 max-w-[1560px] mx-auto flex items-center justify-between pt-6 my-2">
          ...
          <div className="right flex items-center">
            <div className={`menu duration-300 flex-col  justify-center md:flex-row flex fixed w-full ${!toggle ? `right-[-100%] top-0 bottom-0` : `right-0 top-0 bottom-0`} bg-[#15171a] md:static`}>
            ...
            <div onClick={()=>setToggle(true)} className="">
                <div className="open block  md:hidden w-8 ">
                    <div className="w-full h-[1px] my-2 rounded-r-3xl bg-[#15171a]"></div>
                    <div className="w-full h-[1px] my-2 rounded-r-3xl bg-[#15171a]"></div>
                    <div className="w-full h-[1px] my-2 rounded-r-3xl bg-[#15171a]"></div>
                </div>
            </div>
